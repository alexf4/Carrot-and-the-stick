...
For each approved slice, publish a new issue. Apply the `needs-triage` label. Publish in dependency order (blockers first).
...
A reference to the parent issue (if any, otherwise omit).
